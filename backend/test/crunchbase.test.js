...
const { fetchCrunchbase, mapCrunchbase, crunchbaseEnrich } = require("../src/crunchbase")
...
const AirthiumOrganizationSummary =  {
  ...
  stockSymbol: null,
  primaryRole: 'company',
  shortDescription: 'Airthium makes low cost, zero emission, 30kW+ Thermodynamic energy storage systems, as well as high efficiency diesel generators',
  profileImageUrl: 'http://public.crunchbase.com/t_api_images/v1503423190/hbk5jk03rluo7u9mwpig.png',
  domain: 'airthium.com/',
...
test("mapCrunchbase", () => {
  expect(mapCrunchbase(AirthiumOrganizationSummary)).toEqual({
    ...
    Tagline: "Airthium makes low cost, zero emission, 30kW+ Thermodynamic energy storage systems, as well as high efficiency diesel generators",
    Logo: "http://public.crunchbase.com/t_api_images/v1503423190/hbk5jk03rluo7u9mwpig.png",
    Role: undefined,
    ...
    "HQ Location": "Palaiseau, Ile-de-France, France"
  })
})
